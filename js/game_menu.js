...
var buttonConversionBook=new game.ToolButton(0,267,580,98,null,"book","BOOK",game.playerStats.bookStats,"conversion", game.conversionTab, "50 Shades of Sunlight");
...
var buttonConversionSoapbox=new game.ToolButton(0,384,580,98,null,"soapbox","SOAPBOX",game.playerStats.soapboxStats,"conversion", game.conversionTab,"Your own personal moral elevator.");
...
var buttonConversionSpeaker=new game.ToolButton(0,500,580,98,null,"speaker","LOUDSPEAKER",game.playerStats.speakerStats,"conversion",game.conversionTab,"For the hard of hearing. Because they will be, after hearing you.");
...
var buttonConversionPodium=new game.ToolButton(0,617,580,98,null,"podium","PODIUM",game.playerStats.podiumStats,"conversion",game.conversionTab,"You've bought a spot in your local election. Turns out it was pretty cheap.");
...
var buttonConversionCamcorder=new game.ToolButton(0,734,580,98,null,"camcorder","CAMCORDER",game.playerStats.camcorderStats,"conversion",game.conversionTab,"Now you can show your face to all the people in the world who don't care about you.");
...
var buttonConversionComputer=new game.ToolButton(0,849,580,98,null,"computer","COMPUTER",game.playerStats.computerStats,"conversion",game.conversionTab,"A behemoth of a machine, this quad-core Titan still doesn't help you win arguments on the Internet.");
...
var buttonConversionLaptop=new game.ToolButton(0,964,580,98,null,"laptop","LAPTOP",game.playerStats.laptopStats,"conversion",game.conversionTab,"All the convenience of arguing with people who will never understand you, to go!");
...
panelLine=new game.Background(-73,250,648,17,null,"img/panel_line.png");
panelLine.setVisible(true);
game.backgrounds.push(panelLine);

panelLine=new game.Background(-73,365,648,17,null,"img/panel_line.png");
panelLine.setVisible(true);
game.backgrounds.push(panelLine);

panelLine=new game.Background(-73,482,648,17,null,"img/panel_line.png");
panelLine.setVisible(true);
game.backgrounds.push(panelLine);

panelLine=new game.Background(-73,598,648,17,null,"img/panel_line.png");
panelLine.setVisible(true);
game.backgrounds.push(panelLine);

panelLine=new game.Background(-73,715,648,17,null,"img/panel_line.png");
panelLine.setVisible(true);
game.backgrounds.push(panelLine);

panelLine=new game.Background(-73,832,648,17,null,"img/panel_line.png");
panelLine.setVisible(true);
game.backgrounds.push(panelLine);

panelLine=new game.Background(-73,946,648,17,null,"img/panel_line.png");
panelLine.setVisible(true);
game.backgrounds.push(panelLine);

panelLine=new game.Background(-73,1062,648,17,null,"img/panel_line.png");
panelLine.setVisible(true);
game.backgrounds.push(panelLine);

panelLine=new game.Background(646,250,649,17,null,"img/panel_line.png");
panelLine.setVisible(true);
game.backgrounds.push(panelLine);

panelLine=new game.Background(646,365,649,17,null,"img/panel_line.png");
panelLine.setVisible(true);
game.backgrounds.push(panelLine);

panelLine=new game.Background(646,482,649,17,null,"img/panel_line.png");
panelLine.setVisible(true);
game.backgrounds.push(panelLine);

panelLine=new game.Background(646,598,649,17,null,"img/panel_line.png");
panelLine.setVisible(true);
game.backgrounds.push(panelLine);

panelLine=new game.Background(646,715,649,17,null,"img/panel_line.png");
panelLine.setVisible(true);
game.backgrounds.push(panelLine);

panelLine=new game.Background(646,832,649,17,null,"img/panel_line.png");
panelLine.setVisible(true);
game.backgrounds.push(panelLine);

panelLine=new game.Background(646,946,648,17,null,"img/panel_line.png");
panelLine.setVisible(true);
game.backgrounds.push(panelLine);

panelLine=new game.Background(646,1062,648,17,null,"img/panel_line.png");
panelLine.setVisible(true);
game.backgrounds.push(panelLine);
...
var buttonConversionUpgradeSoapbox=new game.UpgradeButton(82,150,85,98,null, "soapbox",game.playerStats.soapboxUpgradeCosts,game.playerStats.soapboxStats, "conversion", 1, game.conversionTab, "Increases the conversion rate of soapbox by 1.5");
...
var buttonConversionUpgradeSpeaker=new game.UpgradeButton(165,150,85,98,null,"speaker",game.playerStats.speakerUpgradeCosts,game.playerStats.speakerStats, "conversion", 1, game.conversionTab,"Increases the conversion rate of speaker by 1.5");
...
var buttonConversionUpgradePodium=new game.UpgradeButton(247,150,85,98,null,"podium",game.playerStats.podiumUpgradeCosts,game.playerStats.podiumStats, "conversion", 1, game.conversionTab, "Increases the conversion rate of podium by 1.5");
...
var buttonConversionUpgradeCamcorder=new game.UpgradeButton(329,150,85,98,null, "camcorder",game.playerStats.camcorderUpgradeCosts,game.playerStats.camcorderStats, "conversion", 1, game.conversionTab, "Increases the conversion rate of camcorder by 1.5");
...
var buttonConversionUpgradeComputer=new game.UpgradeButton(410,150,85,98,null, "computer",game.playerStats.computerUpgradeCosts,game.playerStats.computerStats, "conversion", 1, game.conversionTab, "Increases the conversion rate of computer by 1.5");
...
var buttonConversionUpgradeLaptop=new game.UpgradeButton(494,150,85,98,null, "laptop",game.playerStats.laptopUpgradeCosts,game.playerStats.laptopStats, "conversion", 1, game.conversionTab, "Increases the conversion rate of laptop by 1.5");
...
var buttonCaptureNet=new game.ToolButton(0,267,580,98,null,"net","",game.playerStats.netStats, "capture", game.captureTab,"Bag them and tag them (and decapitate them)");
buttonCaptureNet.setVisible(true);
game.buttons.push(buttonCaptureNet);
game.captureToolButtons.push(buttonCaptureNet);

var buttonCaptureLasso=new game.ToolButton(0,384,580,98,null,"lasso","",game.playerStats.lassoStats,"capture",game.captureTab,"Yeehaw!");
buttonCaptureLasso.setVisible(true);
game.buttons.push(buttonCaptureLasso);
game.captureToolButtons.push(buttonCaptureLasso);

var buttonCaptureTrapdoor=new game.ToolButton(0,500,580,98,null,"trapdoor","",game.playerStats.trapdoorStats,"capture",game.captureTab,"Also can be used for flowerpots, and that weird stand thing in front of bars.");
...
var buttonCaptureVan=new game.ToolButton(0,617,580,98,null,"van","",game.playerStats.vanStats,"capture",game.captureTab,"No, we're not the FBI. Yes, we're still listening.");
buttonCaptureVan.setVisible(true);
game.buttons.push(buttonCaptureVan);
game.captureToolButtons.push(buttonCaptureVan);

var buttonCaptureInvasion=new game.ToolButton(0,734,580,98,null,"invasion","",game.playerStats.invasionStats,"capture",game.captureTab,"Walls are simply a compact way of storing future prisoners.");
...
var buttonCapturePhaser=new game.ToolButton(0,849,580,98,null,"phaser","",game.playerStats.phaserStats,"capture",game.captureTab,"Tried to use this as an execution weapon, but someone keeps leaving it locked to stun.");
buttonCapturePhaser.setVisible(true);
game.buttons.push(buttonCapturePhaser);
game.captureToolButtons.push(buttonCapturePhaser);

var buttonCaptureCloning=new game.ToolButton(0,964,580,98,null,"cloning","",game.playerStats.cloningStats,"capture",game.captureTab,"We breed them to have thin necks.");
...
var buttonExecutionKnife=new game.ToolButton(0,267,580,98,null,"knife","",game.playerStats.knifeStats, "execution", game.executionTab,"stab stab stabby stab");
...
var buttonExecutionCleaver=new game.ToolButton(0,384,580,98,null,"cleaver","",game.playerStats.cleaverStats,"execution",game.executionTab,"I 'ardly knew her!");
...
var buttonExecutionAxe=new game.ToolButton(0,500,580,98,null,"axe","",game.playerStats.axeStats,"execution",game.executionTab,"The favorite weapon of past presidents and crazed writers");
buttonExecutionAxe.setVisible(true);
game.buttons.push(buttonExecutionAxe);
game.executionToolButtons.push(buttonExecutionAxe);

var buttonExecutionBlade=new game.ToolButton(0,617,580,98,null,"blade","",game.playerStats.bladeStats,"execution",game.executionTab,"Do NOT try to use this blade as a top");
...
var buttonExecutionGuillotine=new game.ToolButton(0,734,580,98,null,"guillotine","",game.playerStats.guillotineStats,"execution",game.executionTab,"Literally made for the job");
...
var buttonExecutionSaw=new game.ToolButton(0,849,580,98,null,"saw","",game.playerStats.sawStats,"execution",game.executionTab,"Zombie slaying classic");
buttonExecutionSaw.setVisible(true);
game.buttons.push(buttonExecutionSaw);
game.executionToolButtons.push(buttonExecutionSaw);

var buttonExecutionLightsaber=new game.ToolButton(0,964,580,98,null,"lightsaber","",game.playerStats.lightsaberStats,"execution",game.executionTab,"An elegant weapon for a less civilized age");
...
game.aaxe_1=new game.Achievement(800,1000,"img/achievements/axe1.png", "Axe_1"); game.aaxe_1.checkCondition=function(){     if(game.playerStats.axeStats.numTools > 10){         return true;     } } 
game.achievements.push(game.aaxe_1); game.aaxe_2=new game.Achievement(800,1000,"img/achievements/axe2.png", "Axe_2"); game.aaxe_2.checkCondition=function(){     if(game.playerStats.axeStats.numTools > 100){         return true;     } } 
game.achievements.push(game.aaxe_2); game.aaxe_3=new game.Achievement(800,1000,"img/achievements/axe3.png", "Axe_3"); game.aaxe_3.checkCondition=function(){     if(game.playerStats.axeStats.numTools > 1000){         return true;     } } 
game.achievements.push(game.aaxe_3);
game.ablade_1=new game.Achievement(800,1000,"img/achievements/blade1.png", "Blade_1"); game.ablade_1.checkCondition=function(){     if(game.playerStats.bladeStats.numTools > 10){         return true;     } }
game.achievements.push(game.ablade_1); game.ablade_2=new game.Achievement(800,1000,"img/achievements/blade2.png", "Blade_2"); game.ablade_2.checkCondition=function(){     if(game.playerStats.bladeStats.numTools > 100){         return true;     } }
game.achievements.push(game.ablade_2); game.ablade_3=new game.Achievement(800,1000,"img/achievements/blade3.png", "Blade_3"); game.ablade_3.checkCondition=function(){     if(game.playerStats.bladeStats.numTools > 1000){         return true;     } }
game.achievements.push(game.ablade_3);
game.abook_1=new game.Achievement(800,1000,"img/achievements/book1.png", "Book_1");
game.abook_1.checkCondition=function(){     if(game.playerStats.bookStats.numTools > 10){         return true;     } 
                                      }
game.achievements.push(game.abook_1); game.abook_2=new game.Achievement(800,1000,"img/achievements/book2.png", "Book_2"); game.abook_2.checkCondition=function(){     if(game.playerStats.bookStats.numTools > 100){         return true;     } }
game.achievements.push(game.abook_2); game.abook_3=new game.Achievement(800,1000,"img/achievements/book3.png", "Book_3"); game.abook_3.checkCondition=function(){     if(game.playerStats.bookStats.numTools > 1000){         return true;     } }
game.achievements.push(game.abook_3);
game.acamcorder_1=new game.Achievement(800,1000,"img/achievements/camcorder1.png", "Camcorder_1"); game.acamcorder_1.checkCondition=function(){     if(game.playerStats.camcorderStats.numTools > 10){         return true;     } }
game.achievements.push(game.acamcorder_1); game.acamcorder_2=new game.Achievement(800,1000,"img/achievements/camcorder2.png", "Camcorder_2"); game.acamcorder_2.checkCondition=function(){     if(game.playerStats.camcorderStats.numTools > 100){         return true;     } }
game.achievements.push(game.acamcorder_2); game.acamcorder_3=new game.Achievement(800,1000,"img/achievements/camcorder3.png", "Camcorder_3"); game.acamcorder_3.checkCondition=function(){     if(game.playerStats.camcorderStats.numTools > 1000){         return true;     } }
game.achievements.push(game.acamcorder_3);
game.acleaver_1=new game.Achievement(800,1000,"img/achievements/cleaver1.png", "Cleaver_1"); game.acleaver_1.checkCondition=function(){     if(game.playerStats.cleaverStats.numTools > 10){         return true;     } }
game.achievements.push(game.acleaver_1); game.acleaver_2=new game.Achievement(800,1000,"img/achievements/cleaver2.png", "Cleaver_2"); game.acleaver_2.checkCondition=function(){     if(game.playerStats.cleaverStats.numTools > 100){         return true;     } }
game.achievements.push(game.acleaver_2); game.acleaver_3=new game.Achievement(800,1000,"img/achievements/cleaver3.png", "Cleaver_3"); game.acleaver_3.checkCondition=function(){     if(game.playerStats.cleaverStats.numTools > 1000){         return true;     } }
game.achievements.push(game.acleaver_3);
game.aclone_1=new game.Achievement(800,1000,"img/achievements/clone1.png", "Clone_1"); game.aclone_1.checkCondition=function(){     if(game.playerStats.cloningStats.numTools > 10){         return true;     } }
game.achievements.push(game.aclone_1); game.aclone_2=new game.Achievement(800,1000,"img/achievements/clone2.png", "Clone_2"); game.aclone_2.checkCondition=function(){     if(game.playerStats.cloningStats.numTools > 100){         return true;     } }
game.achievements.push(game.aclone_2); game.aclone_3=new game.Achievement(800,1000,"img/achievements/clone3.png", "Clone_3"); game.aclone_3.checkCondition=function(){     if(game.playerStats.cloningStats.numTools > 1000){         return true;     } }

game.achievements.push(game.aclone_3);
game.acomputer_1=new game.Achievement(800,1000,"img/achievements/computer1.png", "Computer_1"); game.acomputer_1.checkCondition=function(){     if(game.playerStats.computerStats.numTools > 10){         return true;     } }
game.achievements.push(game.acomputer_1); game.acomputer_2=new game.Achievement(800,1000,"img/achievements/computer2.png", "Computer_2"); game.acomputer_2.checkCondition=function(){     if(game.playerStats.computerStats.numTools > 100){         return true;     } }
game.achievements.push(game.acomputer_2); game.acomputer_3=new game.Achievement(800,1000,"img/achievements/computer3.png", "Computer_3"); game.acomputer_3.checkCondition=function(){     if(game.playerStats.computerStats.numTools > 1000){         return true;     } }
game.achievements.push(game.acomputer_3);
game.aguillotine_1=new game.Achievement(800,1000,"img/achievements/guillotine1.png", "Guillotine_1"); game.aguillotine_1.checkCondition=function(){     if(game.playerStats.guillotineStats.numTools > 10){         return true;     } }

game.achievements.push(game.aguillotine_1); game.aguillotine_2=new game.Achievement(800,1000,"img/achievements/guillotine2.png", "Guillotine_2"); game.aguillotine_2.checkCondition=function(){     if(game.playerStats.guillotineStats.numTools > 100){         return true;     } }

game.achievements.push(game.aguillotine_2); game.aguillotine_3=new game.Achievement(800,1000,"img/achievements/guillotine3.png", "Guillotine_3"); game.aguillotine_3.checkCondition=function(){     if(game.playerStats.guillotineStats.numTools > 1000){         return true;     } }

game.achievements.push(game.aguillotine_3);
game.ainvasion_1=new game.Achievement(800,1000,"img/achievements/invasion1.png", "Invasion_1"); game.ainvasion_1.checkCondition=function(){     if(game.playerStats.invasionStats.numTools > 10){         return true;     } }
game.achievements.push(game.ainvasion_1); game.ainvasion_2=new game.Achievement(800,1000,"img/achievements/invasion2.png", "Invasion_2"); game.ainvasion_2.checkCondition=function(){     if(game.playerStats.invasionStats.numTools > 100){         return true;     } }
game.achievements.push(game.ainvasion_2); game.ainvasion_3=new game.Achievement(800,1000,"img/achievements/invasion3.png", "Invasion_3"); game.ainvasion_3.checkCondition=function(){     if(game.playerStats.invasionStats.numTools > 1000){         return true;     } }
game.achievements.push(game.ainvasion_3);
game.aknife_1=new game.Achievement(800,1000,"img/achievements/knife1.png", "Knife_1"); game.aknife_1.checkCondition=function(){     if(game.playerStats.knifeStats.numTools > 10){         return true;     } }
game.achievements.push(game.aknife_1); game.aknife_2=new game.Achievement(800,1000,"img/achievements/knife2.png", "Knife_2"); game.aknife_2.checkCondition=function(){     if(game.playerStats.knifeStats.numTools > 100){         return true;     } }
game.achievements.push(game.aknife_2); game.aknife_3=new game.Achievement(800,1000,"img/achievements/knife3.png", "Knife_3"); game.aknife_3.checkCondition=function(){     if(game.playerStats.knifeStats.numTools > 1000){         return true;     } }
game.achievements.push(game.aknife_3);
game.alaptop_1=new game.Achievement(800,1000,"img/achievements/laptop1.png", "Laptop_1"); game.alaptop_1.checkCondition=function(){     if(game.playerStats.laptopStats.numTools > 10){         return true;     } }
game.achievements.push(game.alaptop_1); game.alaptop_2=new game.Achievement(800,1000,"img/achievements/laptop2.png", "Laptop_2"); game.alaptop_2.checkCondition=function(){     if(game.playerStats.laptopStats.numTools > 100){         return true;     } }
game.achievements.push(game.alaptop_2); game.alaptop_3=new game.Achievement(800,1000,"img/achievements/laptop3.png", "Laptop_3"); game.alaptop_3.checkCondition=function(){     if(game.playerStats.laptopStats.numTools > 1000){         return true;     } }
game.achievements.push(game.alaptop_3);
game.alasso_1=new game.Achievement(800,1000,"img/achievements/lasso1.png", "Lasso_1"); game.alasso_1.checkCondition=function(){     if(game.playerStats.lassoStats.numTools > 10){         return true;     } }
game.achievements.push(game.alasso_1); game.alasso_2=new game.Achievement(800,1000,"img/achievements/lasso2.png", "Lasso_2"); game.alasso_2.checkCondition=function(){     if(game.playerStats.lassoStats.numTools > 100){         return true;     } }
game.achievements.push(game.alasso_2); game.alasso_3=new game.Achievement(800,1000,"img/achievements/lasso3.png", "Lasso_3"); game.alasso_3.checkCondition=function(){     if(game.playerStats.lassoStats.numTools > 1000){         return true;     } }
game.achievements.push(game.alasso_3);
game.alightsaber_1=new game.Achievement(800,1000,"img/achievements/lightsaber1.png", "Lightsaber_1"); game.alightsaber_1.checkCondition=function(){     if(game.playerStats.lightsaberStats.numTools > 10){         return true;     } }
game.achievements.push(game.alightsaber_1); game.alightsaber_2=new game.Achievement(800,1000,"img/achievements/lightsaber2.png", "Lightsaber_2"); game.alightsaber_2.checkCondition=function(){     if(game.playerStats.lightsaberStats.numTools > 100){         return true;     } }
game.achievements.push(game.alightsaber_2); game.alightsaber_3=new game.Achievement(800,1000,"img/achievements/lightsaber3.png", "Lightsaber_3"); game.alightsaber_3.checkCondition=function(){     if(game.playerStats.lightsaberStats.numTools > 1000){         return true;     } }
game.achievements.push(game.alightsaber_3);
game.anet_1=new game.Achievement(800,1000,"img/achievements/net1.png", "Net_1"); game.anet_1.checkCondition=function(){     if(game.playerStats.netStats.numTools > 10){         return true;     } } 
game.achievements.push(game.anet_1); game.anet_2=new game.Achievement(800,1000,"img/achievements/net2.png", "Net_2"); game.anet_2.checkCondition=function(){     if(game.playerStats.netStats.numTools > 100){         return true;     } } 
game.achievements.push(game.anet_2); game.anet_3=new game.Achievement(800,1000,"img/achievements/net3.png", "Net_3"); game.anet_3.checkCondition=function(){     if(game.playerStats.netStats.numTools > 1000){         return true;     } } 
game.achievements.push(game.anet_3);
game.aphaser_1=new game.Achievement(800,1000,"img/achievements/phaser1.png", "Phaser_1"); game.aphaser_1.checkCondition=function(){     if(game.playerStats.phaserStats.numTools > 10){         return true;     } }
game.achievements.push(game.aphaser_1); game.aphaser_2=new game.Achievement(800,1000,"img/achievements/phaser2.png", "Phaser_2"); game.aphaser_2.checkCondition=function(){     if(game.playerStats.phaserStats.numTools > 100){         return true;     } }
game.achievements.push(game.aphaser_2); game.aphaser_3=new game.Achievement(800,1000,"img/achievements/phaser3.png", "Phaser_3"); game.aphaser_3.checkCondition=function(){     if(game.playerStats.phaserStats.numTools > 1000){         return true;     } }
game.achievements.push(game.aphaser_3);
game.apodium_1=new game.Achievement(800,1000,"img/achievements/podium1.png", "Podium_1"); game.apodium_1.checkCondition=function(){     if(game.playerStats.podiumStats.numTools > 10){         return true;     } }
game.achievements.push(game.apodium_1); game.apodium_2=new game.Achievement(800,1000,"img/achievements/podium2.png", "Podium_2"); game.apodium_2.checkCondition=function(){     if(game.playerStats.podiumStats.numTools > 100){         return true;     } }
game.achievements.push(game.apodium_2); game.apodium_3=new game.Achievement(800,1000,"img/achievements/podium3.png", "Podium_3"); game.apodium_3.checkCondition=function(){     if(game.playerStats.podiumStats.numTools > 1000){         return true;     } }
game.achievements.push(game.apodium_3);
game.asaw_1=new game.Achievement(800,1000,"img/achievements/saw1.png", "Saw_1"); game.asaw_1.checkCondition=function(){     if(game.playerStats.sawStats.numTools > 10){         return true;     } } 
game.achievements.push(game.asaw_1); game.asaw_2=new game.Achievement(800,1000,"img/achievements/saw2.png", "Saw_2"); game.asaw_2.checkCondition=function(){     if(game.playerStats.sawStats.numTools > 100){         return true;     } } 
game.achievements.push(game.asaw_2); game.asaw_3=new game.Achievement(800,1000,"img/achievements/saw3.png", "Saw_3"); game.asaw_3.checkCondition=function(){     if(game.playerStats.sawStats.numTools > 1000){         return true;     } } 
game.achievements.push(game.asaw_3);
game.asoapbox_1=new game.Achievement(800,1000,"img/achievements/soapbox1.png", "Soapbox_1"); game.asoapbox_1.checkCondition=function(){     if(game.playerStats.soapboxStats.numTools > 10){         return true;     } }
game.achievements.push(game.asoapbox_1); game.asoapbox_2=new game.Achievement(800,1000,"img/achievements/soapbox2.png", "Soapbox_2"); game.asoapbox_2.checkCondition=function(){     if(game.playerStats.soapboxStats.numTools > 100){         return true;     } }
game.achievements.push(game.asoapbox_2); game.asoapbox_3=new game.Achievement(800,1000,"img/achievements/soapbox3.png", "Soapbox_3"); game.asoapbox_3.checkCondition=function(){     if(game.playerStats.soapboxStats.numTools > 1000){         return true;     } }
game.achievements.push(game.asoapbox_3);
game.aspeaker_1=new game.Achievement(800,1000,"img/achievements/speaker1.png", "Speaker_1"); game.aspeaker_1.checkCondition=function(){     if(game.playerStats.speakerStats.numTools > 10){         return true;     } }
game.achievements.push(game.aspeaker_1); game.aspeaker_2=new game.Achievement(800,1000,"img/achievements/speaker2.png", "Speaker_2"); game.aspeaker_2.checkCondition=function(){     if(game.playerStats.speakerStats.numTools > 100){         return true;     } }
game.achievements.push(game.aspeaker_2); game.aspeaker_3=new game.Achievement(800,1000,"img/achievements/speaker3.png", "Speaker_3"); game.aspeaker_3.checkCondition=function(){     if(game.playerStats.speakerStats.numTools > 1000){         return true;     } }
game.achievements.push(game.aspeaker_3);
game.atrapdoor_1=new game.Achievement(800,1000,"img/achievements/trapdoor1.png", "Trapdoor_1"); game.atrapdoor_1.checkCondition=function(){     if(game.playerStats.trapdoorStats.numTools > 10){         return true;     } }
game.achievements.push(game.atrapdoor_1); game.atrapdoor_2=new game.Achievement(800,1000,"img/achievements/trapdoor2.png", "Trapdoor_2"); game.atrapdoor_2.checkCondition=function(){     if(game.playerStats.trapdoorStats.numTools > 100){         return true;     } }
game.achievements.push(game.atrapdoor_2); game.atrapdoor_3=new game.Achievement(800,1000,"img/achievements/trapdoor3.png", "Trapdoor_3"); game.atrapdoor_3.checkCondition=function(){     if(game.playerStats.trapdoorStats.numTools > 1000){         return true;     } }
game.achievements.push(game.atrapdoor_3);
game.avan_1=new game.Achievement(800,1000,"img/achievements/van1.png", "Van_1"); game.avan_1.checkCondition=function(){     if(game.playerStats.vanStats.numTools > 10){         return true;     } }
game.achievements.push(game.avan_1); game.avan_2=new game.Achievement(800,1000,"img/achievements/van2.png", "Van_2"); game.avan_2.checkCondition=function(){     if(game.playerStats.vanStats.numTools > 100){         return true;     } }
game.achievements.push(game.avan_2); game.avan_3=new game.Achievement(800,1000,"img/achievements/van3.png", "Van_3"); game.avan_3.checkCondition=function(){     if(game.playerStats.vanStats.numTools > 1000){         return true;     } }
